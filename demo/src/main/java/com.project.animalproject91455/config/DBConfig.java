...
public class DBConfig {
    ...
    CommandLineRunner commandLineRunner(AnimalsRepository animalsRepository, UsersRepository usersRepository) {
        return strings -> {
            animalsRepository.save(new Animals(1, "Peter", LocalDate.now(), "Dog",1,"Mammals", "Yossi", 6.50, 27.3, "Good pet", "Very Good pet","../../webPages/static/images/husky.jpeg"));
            animalsRepository.save(new Animals(2, "Lucky", LocalDate.now(), "Toad",1,"Amphibians", "Dov", 2, 13, "Good pet", "Very Good pet","../../webPages/static/images/Frog.jpeg"));
            animalsRepository.save(new Animals(3, "Sharky", LocalDate.now(), "Fish",1,"Fish", "3", 1, 0.200, "Good pet", "Very Good pet",""));
            animalsRepository.save(new Animals(4, "Ricko", LocalDate.now(), "Rats",1,"Rats", "4", 4, 1.5, "Good pet", "Very Good pet","/Users/yoavbrand/Desktop/cat_img.png"));
